...
<IfcCard>
  Your complete code until now should look like{" "}
  <a href="https://github.com/IFCjs/hello-world/tree/main/examples/web-ifc/ifc-to-json/properties/app.js">
    this
  </a>
</IfcCard>
...
<IfcCard>
  We are using this example as a{" "}
  <a href="https://github.com/IFCjs/hello-world/tree/main/examples/web-ifc/ifc-to-json/frontend">
    base{" "}
  </a>
  ...
  <div class="container" id="right-container">
    ...
    <div class="property-container">
      <div class="input-container">
        ...
        <button class="property-button" onclick="getPropertyWithExpressId()">
          Get Properties
        </button>
      </div>
