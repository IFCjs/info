...
<IfcCard icon="🚦" title="Before going forward">
  Basic knowledge of Three.js and web development is assumed. If you don't have
  this background, we recommend that you start{" "}
  <a href="https://threejs.org/manual/">here</a> before jumping into IFC.js.
</IfcCard>
