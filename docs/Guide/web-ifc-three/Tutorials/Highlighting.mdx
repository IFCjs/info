...
<a href="https://threejs.org/docs/#api/en/core/Raycaster">Raycaster</a>. Now
that we have those IDs, it's possible to highlight those elements using <b>
  geometric subsets
</b>.

<IfcCard icon="🧱" title="Geometric subsets?">
  <b>Geometric subsets</b> are any group of items in the model. For example: all
  doors, all ground floor elements or all elements fulfilling a given condition.
</IfcCard>
...
<IfcAlert>
  ...
  ground floor elements of the BIM model and hide the rest.
</IfcAlert>
