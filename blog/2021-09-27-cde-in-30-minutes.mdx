...
<IfcCard>
  🔧🔨 CDEs can have all the functionalities of traditional BIM applications: 3D
...
<IfcCard>
  💪 Google Drive has a lot of power: we can control read and write access to
...
<IfcCard>
  🔑🔑🔑 Following the google guide, you'll need to create a new Google Cloud
  project to get your own CLIENT_ID and API_KEY; they are just two texts that
